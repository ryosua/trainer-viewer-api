...
var addWorkout = function (args, validCategories) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                title = args.title, requiredEquipment = args.requiredEquipment, startTime = args.startTime, link = args.link, duration = args.duration;
                return [4 /*yield*/, orm_1.default.query("INSERT INTO workout (title, " + (requiredEquipment ? 'required_equipment,' : '') + " start_time, link, duration) VALUES (:title, " + (requiredEquipment ? ':required_equipment,' : '') + " :start_time, :link, :duration) RETURNING id", {
                        replacements: { title: title, required_equipment: requiredEquipment, start_time: startTime, link: link, duration: duration },
