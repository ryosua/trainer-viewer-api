    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                durationDivisbleBy10 = duration % 10 === 0;
                if (!durationDivisbleBy10) {
                    throw new Error('The duration must be increments of 10 minutes');
                }
                minDuration = 20;
                maxDuration = 90;
                durationInRange = duration >= minDuration && duration <= maxDuration;
                if (!durationInRange) {
            ...
            case 2:
                ...
                return [2 /*return*/, validCategories];
        }
    });
}); };
exports.default = validateAddWorkout;
